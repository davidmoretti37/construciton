    ...
    <View style={styles.container}>
      ...
      <LinearGradient colors={[C.amber, C.amberDark]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.header}>
        <SafeAreaView edges={['top']} style={styles.headerInner}>
          ...
          <Text style={styles.headerTitle} testID="clientInvoices.headerTitle" accessibilityLabel="clientInvoices.headerTitle">Invoices</Text>
          <View style={{ width: 36 }} />
        </SafeAreaView>
      </LinearGradient>
              ...
              <View key={invoice.id} style={styles.card}>
                ...
                <View style={[styles.cardRow, { marginTop: 8 }]}>
                  ...
                  <View style={[styles.statusBadge, { backgroundColor: status.bg }]}>
                    <Text style={[styles.statusText, { color: status.text }]} testID="clientInvoices.invoiceStatus" accessibilityLabel="clientInvoices.invoiceStatus">{status.label}</Text>
                  </View>
                </View>
                  ...
                  >
                    {paying === invoice.id ? (
                      ...
                      <>
                        ...
                        <Text style={styles.payBtnText}>Pay ${remaining.toLocaleString('en-US')}</Text>
                      </>
                    )}
                  </TouchableOpacity>
                )}
