...
export const resetUserProfile = async () => {
  try {
    ...
    logger.debug('User profile reset successfully');
    return true;
  } catch (error) {
...
export const needsFeatureUpdate = async () => {
  try {
    ...
    if (error) {
      logger.error('Error checking feature updates:', error);
      return { needsUpdate: false, missingFeatures: [] };
    }
...
export const markFeatureUpdateComplete = async () => {
  try {
    ...
    if (fetchError) {
      logger.error('Error fetching migration version:', fetchError);
      return false;
    }
    ...
    if (error) {
      logger.error('Error updating migration version:', error);
      return false;
    }

    logger.debug(`✅ Feature update complete (v${newVersion})`);
    return true;
  } catch (error) {
    logger.error('Error marking feature update complete:', error);
    return false;
  }
};
...
export const removeTrade = async (tradeId) => {
  try {
    ...
    logger.error('Error removing trade:', error);
    return false;
  }
};
...
export const updateTradePricing = async (tradeId, pricing) => {
  try {
    ...
    logger.error('Error updating trade pricing:', error);
    return false;
  }
};
...
export const getItemPricing = async (tradeId, itemId) => {
  try {
    ...
    logger.error('Error getting item pricing:', error);
    return null;
  }
};
...
export const addServiceToTrade = async (tradeId, serviceId, service) => {
  try {
    ...
    logger.error('Error in addServiceToTrade:', error);
    return false;
  }
};
...
export const removeServiceFromTrade = async (tradeId, serviceId) => {
  try {
    ...
    logger.error('Error in removeServiceFromTrade:', error);
    return false;
  }
};
...
export const updateServicePricing = async (tradeId, serviceId, price, unit = null) => {
  try {
    ...
    logger.error('Error in updateServicePricing:', error);
    return false;
  }
};
...
export const saveLanguage = async (languageId) => {
  try {
    ...
    logger.debug('Language saved successfully:', languageId);
    return true;
  } catch (error) {
    logger.error('Error saving language:', error);
    return false;
...
export const hasSelectedLanguage = async () => {
  try {
    ...
    logger.debug('Checking language selection - current language:', language);
    return language !== null && language !== '';
  } catch (error) {
    logger.error('Error checking language selection:', error);
    return false;
  }
};
