  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        ...
        {/* Location Row - Tappable to open maps */}
        {worker.latestClockIn?.location_lat && worker.latestClockIn?.location_lng && (
          <TouchableOpacity
            style={[styles.locationRow, { backgroundColor: '#8B5CF6' + '10' }]}
            onPress={(e) => {
              e.stopPropagation();
              const lat = worker.latestClockIn.location_lat;
              const lng = worker.latestClockIn.location_lng;
