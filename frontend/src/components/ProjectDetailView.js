    ...
    <>
      ...
      <SafeAreaView edges={['top']} style={{ backgroundColor: '#1E3A8A' }} />
        ...
        >
          ...
          {/* (Old standalone Documents section removed — replaced by the
              unified DocumentsCard above the billing area, which mirrors the
              BillingCard pattern and is the only Documents surface now.) */}
