...
const items = [
  ...
  { id: 1, icon: 'briefcase', label: 'Assignments', routeIndex: 1 },
  { id: 2, icon: 'document-text', label: 'DailyReport', routeIndex: 2 },
  { id: 3, icon: 'chatbubbles', label: 'Messages', routeIndex: 3 },
];
