...
import { getPhaseTemplates, createCustomPhase } from '../constants/phaseTemplates';
...
export default function PhasePickerModal({
  ...
  // Get suggested phases based on trades
  const suggestedPhases = getPhaseTemplates(tradeIds[0] || 'construction');
