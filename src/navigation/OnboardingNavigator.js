...
import ProfitMarginScreen from '../screens/onboarding/ProfitMarginScreen';
...
export default function OnboardingNavigator({ onComplete, onGoBack }) {
  return (
    ...
    >
      ...
      {/* NEW FLOW: Services → Phases → Pricing → Business Info → Profit → Invoice → Typical Contracts */}
      ...
      <Stack.Screen name="ProfitMargin" component={ProfitMarginScreen} />
