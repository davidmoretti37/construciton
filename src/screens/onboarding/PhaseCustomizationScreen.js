  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: Colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: Colors.primaryText }]}>Review Phases</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={{ flex: 1 }}>
        ...
        <Text style={[styles.subtitle, { color: Colors.secondaryText, paddingHorizontal: Spacing.xl }]}>
          Review the workflow phases for your services
        </Text>
                ...
                <View style={styles.phaseHeader}>
                  <View style={styles.phaseHeaderLeft}>
                    ...
                    <View style={styles.phaseInfo}>
                      <Text style={[styles.phaseName, { color: '#000000' }]}>
                      ...
                      <Text style={[styles.phaseDays, { color: Colors.secondaryText }]}>
                        ~{phase.defaultDays || phase.default_days || 1} days
                      </Text>
                    </View>
                  </View>
