...
export default function ClientWelcomeScreen({ navigation }) {
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: Colors.background }]}>
      <View style={styles.content}>
        ...
        <View style={[styles.iconContainer, { backgroundColor: '#7C3AED' + '20' }]}>
          <Ionicons name="person" size={80} color="#7C3AED" />
        </View>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={[styles.subtitle, { color: Colors.secondaryText }]}>
            Let's set up your profile so you can track your projects
          </Text>
        </View>
