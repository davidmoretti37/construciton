              ...
              <View style={styles.section}>
                ...
                {projects.map((project) => {
                  ...
                  return (
                    <View
                      key={project.id}
                      style={[styles.projectCard, { backgroundColor: Colors.white, borderColor: Colors.border }]}
                    >
                      {/* Status Bar */}
                      ...
                      <View style={styles.projectHeader}>
                        ...
                        {project.client && (
                          <View style={styles.infoRow}>
                            ...
                            <Text style={[styles.infoText, { color: Colors.secondaryText }]}>{project.client}</Text>
                          </View>
                        )}
